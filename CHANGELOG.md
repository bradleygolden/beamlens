...
- **Beam** — Scheduler utilization tracking, atom leak detection with prediction and source analysis, binary memory leak detection, message queue overload detection, process reduction profiling
